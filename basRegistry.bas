...
'    regDelete_Sub_Key HKEY_CURRENT_USER, _
                  "Software\Suchan Software\TfatERP", "StringTestData"
'
...
'                       "Software\Suchan Software\TfatERP")
'
...
' Syntax:
'    strKeyQuery = regQuery_A_Key(HKEY_CURRENT_USER, _
'                       "Software\Suchan Software\TfatERP", _
                        "StringTestData")
'
  ...
  Select Case lngDataType
         Case REG_SZ:       ' String data (most common)
              ...
              m_lngRetVal = RegQueryValueEx(lngKeyHandle, strRegSubKey, 0&, 0&, _
                  ...
                  If sname = "" Then
                    sname = Mid(strBuffer, 1, Len(strBuffer) - 1)
                  ElseIf nTfatSet = "" Then
                    nTfatSet = Mid(strBuffer, 1, Len(strBuffer) - 1)
                  ElseIf Nature = "" Then
                    Nature = Mid(strBuffer, 1, Len(strBuffer) - 1)
                  End If
...
'   regCreate_A_Key HKEY_CURRENT_USER, "Software\Suchan Software\TfatERP"
' --------------------------------------------------------------
...
' --------------------------------------------------------------
  ...
  '    regCreate_A_Key lngRootKey, "Software\Suchan Software\TfatERP"
  'End If
      
' --------------------------------------------------------------
' see if the next sub key exist.
' --------------------------------------------------------------
  'If Not regDoes_Key_Exist(lngRootKey, "Software\Suchan Software\TfatERP") Then
...
' --------------------------------------------------------------
  'regCreate_Key_Value lngRootKey, "Software\Suchan Software\TfatERP", _
...
' --------------------------------------------------------------
  strKeyQuery = regQuery_A_Key(lngRootKey, "Software\Suchan Software\TfatERP", "Server Name")
  strKeyQuery = regQuery_A_Key(lngRootKey, "Software\Suchan Software\TfatERP", "nTfatSet")
  strKeyQuery = regQuery_A_Key(lngRootKey, "Software\Suchan Software\TfatERP", "Nature")
